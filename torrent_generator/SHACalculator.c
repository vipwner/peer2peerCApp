...
void calculateSHA(char *fileName, char *SHACopy)
{
    ...
    fgets(outputBuffer, sizeof(outputBuffer),
          inputFile); // Obtenemos el resultado del comando openssl.
    ...
    printf("Resultado del comando: %s",
           outputBuffer); // Imprimimos por consola el resultado del comando.
